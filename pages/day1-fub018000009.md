...
Q2. What do %% and %/% mean?
<details>
 A3. X%%y gives the remainder when you divide X by y. X%/%y gives you the quotient you get. These have many useful applications, for example, counting codons or splitting sequences into equal-length lines.
</details>
